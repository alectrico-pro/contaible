...
Cont<sup>ai</sup>ble es un ejemplo de transformación digital, Ud. no podrá lidiar con la complejidad que el enfrentan los gobiernos y las grandes empresas si no hace un graaaaan esfuerzo por mejorar sus sistemas de información de tal forma que en ellos se admnistre el conocimiento de su modelo de negocios.
...
3. Aprender Ud. contabilidad para luego llenar el sistema de contabilidad completa gratuita en SII.
...
Como Cont<sup>ai</sup>ble es un Expert System le queda a mano justificar sus decisiones. Así que Ud. podría confirmar si las reglas realmente superan una prueba con un experto independiente que le audite la contaibilidad. Esto puede ser algo sorprendente viniendo de algo inanimado como un software, pero Cont<sup>ai</sup>ble actúa como la voz autorizada en tema financiero de su empresa y no le fallará, pues si se preocupa de ingresar bien las reglas, los errores serán de los expertos que Ud. use para obtenerlas, no del sotware ni del código. Nunca habrá un error de programación en Cont<sup>ai</sup>le, fuera de que las tablas no le gusten o falte o sobre algo en los informes Ud. puede confiar en el mejor software de la NASA para hacer funcionar la máquina de inferencia de Cont<sup>ai</sup>ble. En este sentido Cont<sup>ai</sup>ble es un software World Class, pues está construido sobre un software World Class: un clásico sin fallas. 


[blog](https://blog.necios.cl)|[cont<sup>ai</sup>ble](https://https://alectrico-pro.github.io/contaible/)
