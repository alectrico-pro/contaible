...
(defrule calculo-de-descuentos-legales
  ...
  =>
   ...
   ( printout t " Comisión AFP " tab ?comision tab (* ?sueldo ?comision) crlf)
   ( printout t " ---- " crlf)
   ...
   ( printout t "Total a Pagar al Fondo de Cesantía" tab ?afc tab (* ?sueldo ?afc) crlf)
   ( printout t " PLANILLA SALUD    " crlf)
   ( printout t " Cotización Legal              "  tab ?salud tab  (* ?sueldo ?salud) crlf)
