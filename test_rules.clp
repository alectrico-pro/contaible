...
;   ( focus TICKET PRIMITIVA ACTIVIDAD PRIMITIVA PARTIDA LIBRO-MAYOR TOTAL AJUSTE INVENTARIO LIQUIDACION INVENTARIO_FINAL AJUSTE TA TRIBUTARIO )
  ...
  ( focus TICKET PRIMITIVA ACTIVIDAD PRIMITIVA PARTIDA VALOR_ACTIVOS PRIMITIVA LIBRO-MAYOR TOTAL RESULTADO-SII AJUSTE INVENTARIO LIQUIDACION AJUSTE TA TRIBUTARIO AJUSTEC TOTALC FINAL )
